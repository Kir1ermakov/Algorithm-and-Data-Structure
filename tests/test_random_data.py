...
class TestAscii85Compliance(unittest.TestCase):
    ...
    def test_a85_encode_matches_python(self):
        ...
        for _ in range(50):
            ...
            py_encoded = base64.a85encode(data)
            ...
            self.assertEqual(proc.stdout.rstrip(b"\n"), py_encoded, "Наше кодирование не совпадает с base64.a85encode")
    ...
    def test_a85_decode_matches_python(self):
        ...
        for _ in range(50):
            ...
            self.assertEqual(proc.stdout, data, "Наше декодирование не совпадает с base64.a85decode")

            proc2 = subprocess.run([self.ascii85_exe, '-eb'], input=data, capture_output=True, text=False)
            self.assertEqual(proc2.returncode, 0)
            py_decoded = base64.a85decode(proc2.stdout)
